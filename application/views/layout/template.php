    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <?php if ($uri==""): ?>
                    <a class="navbar-brand page-scroll" href="#page-top">Survei Kepuasan Masyarakat</a>
                <?php else: ?>
                    <a class="navbar-brand page-scroll" href="<?php echo site_url('') ?>">Survei Kepuasan Masyarakat</a>
                <?php endif; ?>
